...
import { loadConfig, resolveReporting, resolvePosthog, commandFor } from "./config.js";
...
export async function run(args) {
  ...
  // A second, independent sink. Both may be configured, either may be, or
  // neither — they answer different questions (a dashboard for one run, a
  // warehouse for the trend) and neither is a fallback for the other.
